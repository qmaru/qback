...
func (c *fileTransferServiceClient) ServerCheck(ctx context.Context, in *Ping, opts ...grpc.CallOption) (*Pong, error) {
	out := new(Pong)
	err := c.cc.Invoke(ctx, FileTransferService_ServerCheck_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileTransferServiceClient) SendMeta(ctx context.Context, in *MetaRequest, opts ...grpc.CallOption) (*MetaResponse, error) {
	...
	err := c.cc.Invoke(ctx, FileTransferService_SendMeta_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileTransferServiceClient) SendFile(ctx context.Context, opts ...grpc.CallOption) (FileTransferService_SendFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileTransferService_ServiceDesc.Streams[0], FileTransferService_SendFile_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
